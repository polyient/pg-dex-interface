...
function Web3StatusInner() {
  ...
  if (account) {
    return (
      <div>
        <div className="input-group pg-loaded-input">
        {account && userEthBalance ? (
          <span className="form-control custom-input"> {userEthBalance?.toSignificant(4)} ETH</span>
          ) : <span className="form-control custom-input"> ... ETH</span>}
